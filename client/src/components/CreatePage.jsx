    ...
    <section className='mx-16 my-8'>
        ...
        <div className="flex justify-center items-center gap-16">
            ...
            <div className="p-6">
                ...
                <input type="text" className='w-full my-2 rounded p-4 h-12 border-none mb-6'/>
                <label htmlFor="name" className='text-left text-white '>Blog Body</label>
                <textarea name="body" id="blogbody" cols="30" rows="10" className='my-2 w-full rounded p-4 border-none mb-6 h-48'></textarea>
